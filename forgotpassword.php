    ...
    <ul class="nav navbar-nav" style="color: #095dbc">
      ...
      <?php } ?> 
	        ...
	        <br/> <br/>
                ...
                Username: <input type="text" class="emailRegister" name="usernameSignin" required/><br/>
                Email: <input type="email" class="emailRegister" name="emailRegister" required/><br/>
                Choose a new password: <input type="password" class="passRegister" name="passRegister" required/><br/>
                Re-enter the password: <input type="password" class="passRegister2" name="passRegister2" required/><br/>
                <input type="submit" class="btn btn-default" value="Change password!"/>
                <br/><br/><a href="signin.php" style="font-weight: bold;">Already registered? Click here to Sign in..</a>
                </form>
